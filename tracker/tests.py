...
def create_product(product_name, product_type, days, amount):
    """
    ...
    return Product.objects.create(product_name=product_name, product_type=product_type, entry_date=time, amount=amount)
...
class ProductModelTests(TestCase):
    def test_was_bought_recently_with_old_product(self):
        ...
        product = Product(product_name="Banana", product_type = "fruit", entry_date = time, amount = 3)
...
#     def test_modify_with_positive_number(self):
#         """
#         Test if adding more than 0 amount updates the product amount correctly
#         """
#         product = create_product("Banana", "fruit", 1, 3)
#         self.assertEqual(product.modify())